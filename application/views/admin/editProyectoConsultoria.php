        ...
        <div class="span12">   
          ...
          <div class="widget ">
            <div class="widget-header">
                ...
                <h3>Consultoria - Editar proyecto</h3>
            </div> <!-- /widget-header -->
            <div class="widget-content">
              <div class="tabbable">
                <form id="edit-profile" class="form-horizontal"  enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>admin/editarProyectoConsultoria/<?php echo $id ?>">
                  ...
                  <fieldset>  
                    ...
                    <?php } ?>
                      <div class="form-actions">
                        ...
                        <a href="<?php echo base_url(); ?>admin/consultoria_admin" class="btn">Cancelar Cambios</a>
                      </div>
                  </fieldset>
                </form>
              </div>
